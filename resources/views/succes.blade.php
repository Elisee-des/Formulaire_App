...
<head>
    ...
    <title>Consultants-sm/ succès</title>
    ...
    <!-- Bootstrap core CSS -->
    <link href="{{ asset('assets/css/bootstrap.mim.css') }}" rel="stylesheet">
...
<body>
    ...
    <div class="container">
        <div class="card p-3">
            <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
                <h2 class="text-success">Merci d'avoir remplis le formulaire</h2>
    ...
    <script src="{{ asset('assets/js/hoder.min.js') }}"></script>
